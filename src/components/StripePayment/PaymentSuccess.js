...
import { verifyStripePaymentAPI } from "../../apis/stripePayment/stripePayment";
...
const PaymentSuccess = () => {
  ...
  const { isLoading, isError, isSuccess, data, isPending } = useQuery({
    queryKey: ["verify-stripe-payment"],
    queryFn: () => verifyStripePaymentAPI(paymentIntentID),
  });
